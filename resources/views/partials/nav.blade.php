@php
    ...
    $navItems = [
        ...
        [
            'route' => 'activitylog-browse.deletion-history',
            'label' => __('activitylog-browse::messages.deletion_history'),
            'icon'  => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',
            'active' => request()->routeIs('activitylog-browse.deletion-history') || request()->routeIs('activitylog-browse.clear-deletion-history'),
        ],
        [
